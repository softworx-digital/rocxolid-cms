        ...
        <div class="row">
            ...
            <div class="col-sm-7 col-xs-1">
                ...
                @can ('update', $component->getModel())
                    <a class="btn btn-default" data-ajax-url="{{ $component->getModel()->getControllerRoute('edit', [ '_section' => 'footer', 'page_id' => $component->getModel() ]) }}" class="margin-left-5 pull-right">
