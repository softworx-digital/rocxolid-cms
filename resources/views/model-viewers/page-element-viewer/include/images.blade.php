<ul id="{{ $component->getDomId('images', $component->getModel()->getKey()) }}" class="list-unstyled images text-center col-xs-12 sortable ajax-overlay" data-update-url="{{ $component->getModel()->getControllerRoute('reorder', [ 'relation' => 'images' ]) }}">
