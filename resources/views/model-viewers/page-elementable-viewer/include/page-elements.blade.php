<div id="{{ $component->makeDomId('page-elements', $component->getModel()->id) }}" style="margin-top: -15px;">
    ...
    @foreach ($component->getModel()->pageElements() as $page_element)
        {!! $page_element->getModelViewerComponent()->render('in-page-elementable', [ 'page_elementable' => $component->getModel() ]) !!}
    @endforeach
    </ul>
</div>