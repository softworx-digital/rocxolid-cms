<div id="{{ $component->makeDomId('modal-select-page-element') }}" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        {{ Form::open([ 'id' => $component->makeDomId('select-page-element'), 'url' => $component->getModel()->getControllerRoute('selectPageElement', [ 'page_element_short_class' => $page_element_short_class ]) ]) }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success pull-right" data-ajax-submit-form="{{ $component->makeDomIdHash('select-page-element') }}"><i class="fa fa-check margin-right-10"></i>{{ $component->translate('button.save', false) }}</button>
            </div>
        {!! Form::close() !!}
        </div>
    </div>
