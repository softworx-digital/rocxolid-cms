    ...
    <div class="modal-dialog modal-xl">
        ...
        {{ Form::open([ 'id' => $component->getDomId('list-containee'), 'url' => $component->getModel()->getControllerRoute('listContainee') ]) }}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success pull-right" data-ajax-submit-form="{{ $component->getDomIdHash('list-containee') }}"><i class="fa fa-check margin-right-10"></i>{{ $component->translate('button.save', false) }}</button>
            </div>
        {!! Form::close() !!}
        </div>
    </div>
