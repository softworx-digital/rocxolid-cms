    ...
    @can ('create', [ $component->getModel(), 'items' ])
        <div class="row">
            <div class="btn-group col-xs-12">
                <a
                    type="button"
                    data-ajax-url="{{ $component->getModel()->getNavigationItem()->getControllerRoute('create', [ '_section' => 'row-navigation-items', '_data[container_id]' => $component->getModel()->getKey() ]) }}"
