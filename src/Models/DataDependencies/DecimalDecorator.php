...
/**
 * Decorator for DECIMAL typed custom data dependencies.
 *
 * @author softworx <hello@softworx.digital>
 * @package Softworx\RocXolid\CMS
 * @version 1.0.0
 */
class DecimalDecorator extends AbstractDataDependencyDecorator
{
    /**
     * {@inheritDoc}
     */
        ...
        return [
            $this->getAssignmentDefaultName() => [
                ...
                'options' => [
                    ...
                    'value' => $this->elementable_dependency->getAttributeViewValue('default_value_decimal'),
                    'validation' => [
                        'rules' => [
                            $this->elementable_dependency->is_required ? 'required' : 'nullable',
                            'decimal',
                            'min_decimal:' . ($this->elementable_dependency->min ?? '-1000000000'),
                            'max_decimal:' . ($this->elementable_dependency->max ?? '1000000000'),
                        ],
                    ],
                ],
            ],
