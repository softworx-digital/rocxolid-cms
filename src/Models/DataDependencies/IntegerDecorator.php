...
/**
 * Decorator for INTEGER typed custom data dependencies.
 *
 * @author softworx <hello@softworx.digital>
 * @package Softworx\RocXolid\CMS
 * @version 1.0.0
 */
class IntegerDecorator extends AbstractDataDependencyDecorator
{
    /**
     * {@inheritDoc}
     */
        ...
        return [
            $this->getAssignmentDefaultName() => [
                ...
                'options' => [
                    ...
                    'value' => $this->elementable_dependency->default_value_integer,
                    'validation' => [
                        'rules' => [
                            $this->elementable_dependency->is_required ? 'required' : 'nullable',
                            'integer',
                            'min:' . ($this->elementable_dependency->min ?? '-1000000000'),
                            'max:' . ($this->elementable_dependency->max ?? '1000000000'),
                        ],
                    ],
                ],
            ],
